...
namespace BnGClub.Controllers
{
    public class ActivitiesController : Controller
    {
        ...
        {
            var appts = from a in _context.Activities
                       .Include(a => a.ActType)
                       .Include(a => a.Leader)
                        ...
                        select new
                        {
                            ...
                            Code = a.actCode,
                            Require = a.actRequirement,
                            available = a.actAvailablePlace,
                            leader = a.Leader.FullName,
                            accttype = a.ActType.acttypeName
            ...
            if (numRows > 0) //We have data
            {
                ...
                workSheet.Cells[1, 1].Value = "Activities Report";
                ...
                //    IActionResult, we could do this:
        ...
        public async Task<IActionResult> InsertFromExcel(IFormFile theExcel)
        {
            ...
            for (int row = start.Row; row <= end.Row; row++)
            {
                ...
                Activities at = new Activities
                {
                    ...
                    LeaderID = workSheet.Cells[row, 6].Columns,
                    ActTypeID = workSheet.Cells[row, 5].Columns

                };
                _context.Activities.Add(at);
            };
