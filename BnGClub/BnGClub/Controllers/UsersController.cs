...
namespace BnGClub.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(BnGClubContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,userFName,userMName,userLName,userEmail,userPhone,notificationOptIn")] Users users)
        {
            if (id != users.ID)
            {
                return NotFound();
